...
public class RumahSakitDemo {
    public static void main(String[] args) {
        ...
        Pegawai desi = new Pegawai("1235", "Ns. Desi");
        Pegawai eka = new Pegawai("4567", "Ns. Eka");

        Pasien pasien1 = new Pasien("343298", "Puspa Widya");
        pasien1.tambahKonsultasi(java.time.LocalDate.of(2021, 8, 11), ani, desi);
        pasien1.tambahKonsultasi(java.time.LocalDate.of(2021, 8, 11), bagus, eka);
